...
df = pd.read_csv("Amisiyas/MOT_2020_2024 mobile county/mot_mobile_2020.csv")
...
df = df.rename(columns={
    ...
    'Mobile County, Alabama!!Public transportation (excluding taxicab)!!Estimate': 'Public Transportation'
})
