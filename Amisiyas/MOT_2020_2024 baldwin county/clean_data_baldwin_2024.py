...
# Dataset loading, viewing, and cleaning for 2024, Baldwin County, Alabama

df = pd.read_csv("Amisiyas/MOT_2020_2024 baldwin county/mot_baldwin_2024.csv")
...
df = df.drop([
    ...
    'Baldwin County, Alabama!!Public transportation!!Margin of Error',
    'Baldwin County, Alabama!!Worked from home!!Margin of Error'
], axis=1)
...
df = df.rename(columns={
    ...
    'Baldwin County, Alabama!!Public transportation!!Estimate': 'Public Transportation',
    'Baldwin County, Alabama!!Worked from home!!Estimate': 'Worked from Home'
})
